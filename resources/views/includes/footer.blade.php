<footer class="footer items-center p-4 bg-base-300/50 text-neutral-content" style="overflow-x: hidden;">
    <aside class="items-center grid-flow-col">
        ...
        <p class="text-base-content">Copyright © 2024 - All right reserved by Guignard Sacha</p>
    </aside>
